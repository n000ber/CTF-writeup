...
|---|---|--|
|1|Finding hidden directory|*|
|2|Brute-forcing password|*|
|3|Cookie attack (Timestamp)|**|
|4|Cookie attack (Structured tokens)|**|
|5|Referer header|*|
|6|Insecure file naming|**|
|7|Insecure admin validation|****|
|8|Changing request method|****|
|9|Bypassing 2FA|****|
